...
ALLOWED_HOSTS = ["127.0.0.1", "spy.satellites.smartian.space"]
...
ROOT_URLCONF = "satellite_spy.urls"
...
WSGI_APPLICATION = "satellite_spy.wsgi.application"
...
CRON_CLASSES = ["api.jobs.UpdatePages"]
